...
public class InvoicesDirectory<Name, InvoicesNumber, Payment> implements InvoicesDictionaryInterface<Name, InvoicesNumber, Payment>{
	private class AvlTreeInvoices<Tree extends Comparable<? super Tree>>{
		private AvlNode<Tree> root;
		private static final int ALLOWED_IMBALANCE = 1;
	    public AvlTreeInvoices( ){this.root = null;}
		private class AvlNode<Tree>{
	        ...
	        AvlNode<Tree> right;   
	        int height;
	        AvlNode( Tree theElement, AvlNode<Tree> lt, AvlNode<Tree> rt , Invoice value)
	        {
	            element  = theElement;
	            left     = lt;
	            right    = rt;
	    ...
	    public void insert( Tree x , Invoice value){this.root = insert( x, this.root, value );}
	    private AvlNode<Tree> insert( Tree x, AvlNode<Tree> t, Invoice value){
	...
	@Override
	public InvoicesNumber add(Name k, InvoicesNumber Item, Payment Item2) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public InvoicesNumber remove(Name k) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public InvoicesNumber getValue(Name k) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public boolean contains(Name k) {
		// TODO Auto-generated method stub
		return false;
	}
	...
	@Override
	public Iterator<InvoicesNumber> getValueIterator() {
		// TODO Auto-generated method stub
		return null;
	}
